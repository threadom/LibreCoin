...
def control(lc:librecoin):
    lc.keyboard().press("DB", "lc.view().set('views.tDashboard')")
    lc.keyboard().press("WL", "lc.view().set('views.tWallet')")
    lc.keyboard().press("TS", "lc.view().set('views.tTransactions')")
    lc.keyboard().press("CH", "lc.view().set('views.tCryptoHisto')")
    lc.keyboard().press("TR", "lc.view().set('views.tTradeRules')")
    lc.keyboard().press("BR", "lc.view().set('views.tBuyRules')")
    lc.keyboard().press("SR", "lc.view().set('views.tSellRules')")
    lc.keyboard().press("CF", "lc.view().set('views.tConfig')")
    lc.keyboard().press("QQ", "lc.view().set('views.tQuit')")
