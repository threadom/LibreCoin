...
# total = 0
# for currency in accounts:
#     balance = float(currency.native_balance.amount)
#     if balance > 0:
#         print(currency)
#         total += balance
#         print("# " + currency.currency + " : " + str(balance) + " " + currency.native_balance.currency)

#         transactions = get_all_transactions(client, currency.currency)
#         for transaction in transactions:
#             amount = float(transaction.native_amount.amount)
#             if amount > 0:
#                 print("# ---> " + transaction.type + ' ' + currency.currency + " : " + str(amount) + " " + transaction.native_amount.currency)
