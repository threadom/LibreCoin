...
#     tmp['values'][currency]['-0'] = lc.history(currency,'EUR', -0, 60)['close']
    ...
    lc.display().print(" M7:   Menu 6 ", 91, 1)
    lc.display().table(105,0,16,3)
    lc.display().print(" M8:   Menu 6 ", 106, 1)
    lc.display().table(120,0,16,3)
    lc.display().print(" M9:   Menu 6 ", 121, 1)
    lc.display().table(135,0,16,3)
    lc.display().print(" M0:     Quit ", 136, 1)
