...
def control(lc:librecoin):
    lc.keyboard().press("DB", "lc.view().set('views.vDashboard')")
    lc.keyboard().press("WL", "lc.view().set('views.vWallet')")
    lc.keyboard().press("TS", "lc.view().set('views.vTransactions')")
    lc.keyboard().press("CH", "lc.view().set('views.vCryptoHisto')")
    lc.keyboard().press("TR", "lc.view().set('views.vTradeRules')")
    lc.keyboard().press("BR", "lc.view().set('views.vBuyRules')")
    lc.keyboard().press("SR", "lc.view().set('views.vSellRules')")
    lc.keyboard().press("CF", "lc.view().set('views.vConfig')")
    lc.keyboard().press("QQ", "lc.view().set('views.vQuit')")
